...
namespace ClienteWeb.Pages.ReportePDPF
{
    public class IndexModel : PageModel
    {
        ...
        public async Task getr()
        {
            ...
            using (httpClient)
            {
                ...
                var data = new { username = "develop", fechaInicial = fecha1, fechaFinal = fecha2 };



                var content = new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json");
                var response = await httpClient.PostAsync("http://localhost:5119/api/reporte/admin/paquetesDispByFechas", content);
