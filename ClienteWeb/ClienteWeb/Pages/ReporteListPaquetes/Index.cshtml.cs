...
namespace ClienteWeb.Pages.ReporteListPaquetes
{
    public class IndexModel : PageModel
    {
        ...
        public async Task getr()
        {
            ...
            using (httpClient)
            {
                ...
                var data   = new { username = "develop", categoria = opcion,numElementos=cantidad };



                    var content = new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json");
                    var response = await httpClient.PostAsync("http://localhost:5119/api/reporte/admin/listadoPaquetesCategoria", content);
