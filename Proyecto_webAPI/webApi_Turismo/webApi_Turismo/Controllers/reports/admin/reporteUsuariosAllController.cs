...
{
    [ApiController]
    [Route("api/reporte/admin/listadoUsuariosAll")]
    public class reporteUsuariosAllController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteUsuariosAllController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult reporteUsuarios([FromBody] cReporteUsuariosByLetter modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[8].ToString();
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_ListadoUsuariosAll.pdf";
