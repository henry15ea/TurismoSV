...
{
    [ApiController]
    [Route("api/reporte/admin/adicionalesDisponiblesIdPkg")]
    public class reporteAdicionalesDisponiblesByPkgIdController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteAdicionalesDisponiblesByPkgIdController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReporteAdicionalesDisponiblesByPkgID modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[6].ToString();
                    ...
                    report.SetParameterValue("id_paquete", modelo.Id_paquete.Trim());
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_ListadoAdicionalesByPaquete.pdf";
