...
{
    [ApiController]
    [Route("api/reporte/admin/paquetesDispByFechas")]
    public class reportePaquetesDisponiblesByFechaController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reportePaquetesDisponiblesByFechaController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReportePaquetesDisponiblesByFinicialFinal modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[7].ToString();
                    ...
                    report.SetParameterValue("username", modelo.Username.Trim());
                    report.SetParameterValue("fecha_inicial", modelo.FechaInicial.Trim());
                    report.SetParameterValue("fecha_final", modelo.FechaFinal.Trim());
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_ListadoPaquetesFechas.pdf";
            ...
            catch (Exception ex)
            {
                dataResponse = new
                {
                    ...
                    ServerApiStatus = "Problema a nivel de api a crear reporte " + ex.ToString()
                };
