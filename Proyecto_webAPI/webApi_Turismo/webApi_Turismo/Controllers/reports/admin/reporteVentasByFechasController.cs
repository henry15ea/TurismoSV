...
{
    [ApiController]
    [Route("api/reporte/admin/ventasByFechas")]
    public class reporteVentasByFechasController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteVentasByFechasController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReportVentasByFechasModel modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[11].ToString();
                    ...
                    report.SetParameterValue("fechaIni", modelo.FechaInicio);
                    report.SetParameterValue("fechFin", modelo.FechaFinal);
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_VentasPorFechas.pdf";
