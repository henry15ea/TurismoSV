...
{
    [ApiController]
    [Route("api/reporte/admin/listadoPaquetesCategoria")]
    public class reporteListadoPaquetesAllController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteListadoPaquetesAllController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReportePaquetesByCategoria modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[3].ToString();
                    ...
                    report.SetParameterValue("nombreCategoria", modelo.Categoria.Trim());
                    report.SetParameterValue("numElementos", modelo.NumElementos);
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_ListadoPaquetesByCategoria.pdf";
