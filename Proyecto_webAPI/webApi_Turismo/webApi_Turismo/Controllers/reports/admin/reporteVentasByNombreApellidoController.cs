...
{
    [ApiController]
    [Route("api/reporte/admin/ventasAdicionalesByNombreApellido")]
    public class reporteVentasByNombreApellidoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteVentasByNombreApellidoController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReporteVentasByNombreApellido modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[13].ToString();
                    ...
                    report.SetParameterValue("name", modelo.Nombre.Trim().ToUpper());
                    report.SetParameterValue("lastName", modelo.Apellido.Trim().ToUpper());
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_VentasAdcicionalesByPaquete.pdf";
