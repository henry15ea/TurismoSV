...
{
    [ApiController]
    [Route("api/reporte/admin/listadoCategorias")]
    public class reporteCategoriaListController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteCategoriaListController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult reporteUsuarios([FromBody] cUserModel modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[5].ToString();
                    ...
                    report.SetParameterValue("username", ct.Nombre + " "+ ct.Apellido);
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_ListadoCategorias.pdf";
