...
{
    [ApiController]
    [Route("api/reporte/admin/ventasAdicionales")]
    public class reporteVentasAdicionalesController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteVentasAdicionalesController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult reporteUsuarios([FromBody] cUserModel modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[9].ToString();
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_VentasAdcicionales.pdf";
