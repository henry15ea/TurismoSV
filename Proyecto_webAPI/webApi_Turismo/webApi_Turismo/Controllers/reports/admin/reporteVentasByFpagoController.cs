...
{
    [ApiController]
    [Route("api/reporte/admin/ventasAdicionalesByFpago")]
    public class reporteVentasByFpagoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteVentasByFpagoController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult reporteUsuarios([FromBody] cReporteUsuariosByLetter modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[12].ToString();
                    ...
                    report.SetParameterValue("PagoM", modelo.filtro);
