...
{
    [ApiController]
    [Route("api/reporte/admin/ventasAdicionalesByPaquete")]
    public class reporteAdicionalesByPkgController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteAdicionalesByPkgController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReporteUsuariosByLetter modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[10].ToString();
                    ...
                    report.SetParameterValue("paquete",modelo.filtro);
