...
{
    [ApiController]
    [Route("api/reporte/admin/listadoAdicionales")]
    public class reporteAdicionalesDisponiblesByNombreController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public reporteAdicionalesDisponiblesByNombreController(IWebHostEnvironment webHostEnvironment)
        {
            _webHostEnvironment = webHostEnvironment;
        }

        [HttpPost]
        public IActionResult reporteUsuarios([FromBody] cReporteListadoAdicionalByNombre modelo)
        {
            ...
            try
            {
                ...
                if (ct != null && ct.Id_rol.Equals(1))
                {
                    ...
                    String reportPath = _webHostEnvironment.ContentRootPath + ruta.GetRoutes()[4].ToString();
                    ...
                    report.SetParameterValue("nmb", modelo.NombreAdicional.Trim());
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        reporteFileName = DateTime.Now + "_ListadoAdicionalesByNombre.pdf";
