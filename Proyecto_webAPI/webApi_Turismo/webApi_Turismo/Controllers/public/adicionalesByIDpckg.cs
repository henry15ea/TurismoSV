...
namespace webApi_Turismo.Controllers
{
    ...
    public class adicionalesbyid : Controller
{
        private readonly IConfiguration _configuration;


        public adicionalesbyid(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult adicionales([FromBody] vidAdicionalModel id)
        {
            bool getdata = false;
            var dataResp = new
            {
            ...
            try
            {
                adicionales = dp.GetAdicionalesByPckgIdList(id);
                getdata = true;
            }
            catch
            {
