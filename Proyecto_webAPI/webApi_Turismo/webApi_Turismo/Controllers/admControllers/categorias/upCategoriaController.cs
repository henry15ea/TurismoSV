...
namespace webApi_Turismo.Controllers.admControllers.categorias
{
    ...
    public class upCategoriaController : Controller
    {
        private readonly IConfiguration _configuration;


        public upCategoriaController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult actualizaCategoria([FromBody] cUpCategorias modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_updatedCategoria(modelo) == true)
                {
