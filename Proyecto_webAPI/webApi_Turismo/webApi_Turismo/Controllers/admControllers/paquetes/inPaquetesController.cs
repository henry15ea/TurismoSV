...
namespace webApi_Turismo.Controllers.admControllers.paquetes
{
    ...
    public class inPaquetesController : Controller
    {
        private readonly IConfiguration _configuration;


        public inPaquetesController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult nuevoPaquete([FromBody] cinPaquetesModel modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_nuevoPaquete(modelo) == true)
                {
