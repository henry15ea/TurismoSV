...
namespace webApi_Turismo.Controllers.admControllers.fpago
{
    ...
    public class inFpagoController : Controller
    {
        private readonly IConfiguration _configuration;


        public inFpagoController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult nuevaFpago([FromBody] cFormasPagoModel modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_nuevoFpago(modelo) == true)
                {
