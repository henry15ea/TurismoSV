...
namespace webApi_Turismo.Controllers.admControllers.adicionalesdisp
{
    ...
    public class delAdicionalesDispController : Controller
    {
        private readonly IConfiguration _configuration;


        public delAdicionalesDispController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult eliminarAdicionaldisp([FromBody] cDeleteModel modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_deleteADicionalDisp(modelo) == true)
                {
