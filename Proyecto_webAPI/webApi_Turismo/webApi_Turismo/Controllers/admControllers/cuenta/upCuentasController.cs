...
namespace webApi_Turismo.Controllers.admControllers.cuenta
{
    ...
    public class upCuentasController : Controller
    {
        private readonly IConfiguration _configuration;


        public upCuentasController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult actualizaCategoria([FromBody] cUpCuentas modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_updateCuenta(modelo) == true)
                {
