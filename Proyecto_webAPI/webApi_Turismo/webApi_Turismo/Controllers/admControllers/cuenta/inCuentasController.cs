...
namespace webApi_Turismo.Controllers.admControllers.cuenta
{
    ...
    public class inCuentasController : Controller
    {
        private readonly IConfiguration _configuration;


        public inCuentasController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult nuevaCuenta([FromBody] cInCuenta modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_nuevaCuenta(modelo) == true)
                {
