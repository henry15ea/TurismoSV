...
namespace webApi_Turismo.Controllers.admControllers.factura.detalle
{
    ...
    public class delDetalleFacturaController : Controller
    {
        private readonly IConfiguration _configuration;


        public delDetalleFacturaController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult eliminarDetalleFactura([FromBody] cDeleteModel modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_deleteDetalleFactura(modelo) == true)
                {
