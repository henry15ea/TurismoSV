...
namespace webApi_Turismo.Controllers.admControllers.factura.encabezado
{
    ...
    public class delEncabezadoFController : Controller
    {
        private readonly IConfiguration _configuration;


        public delEncabezadoFController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult eliminarEncabezadoF([FromBody] cDeleteModel modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_deleteEncabezadoFactura(modelo) == true)
                {
