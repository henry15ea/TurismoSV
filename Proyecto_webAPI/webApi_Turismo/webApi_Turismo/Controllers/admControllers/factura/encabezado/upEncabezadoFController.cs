...
namespace webApi_Turismo.Controllers.admControllers.factura.encabezado
{
    ...
    public class upEncabezadoFController : Controller
    {
        private readonly IConfiguration _configuration;


        public upEncabezadoFController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult actualizaEncabezadoF([FromBody] cUpEncabezado modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_updateEncabezadoFactura(modelo) == true)
                {
