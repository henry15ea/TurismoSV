...
namespace webApi_Turismo.Controllers.admControllers.personasExtras
{
    ...
    public class delPersonasExtrasController : Controller
    {
        private readonly IConfiguration _configuration;


        public delPersonasExtrasController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult eliminarPersonaExtra([FromBody] cDeleteModel modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_deletePersonaExtra(modelo) == true)
                {
