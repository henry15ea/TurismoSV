...
namespace webApi_Turismo.Controllers.admControllers.personasExtras
{
    ...
    public class inPersonasExtrasController : Controller
    {
        private readonly IConfiguration _configuration;


        public inPersonasExtrasController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult nuevaPersonaExtra([FromBody] cInPersonasExtras modelo)
        {
            var dataResp = new
            {
                token_paquete = "null",
            ...
            else
            {
                ...
                if (lv.fn_nuevaPersonaExtra(modelo) == true)
                {
