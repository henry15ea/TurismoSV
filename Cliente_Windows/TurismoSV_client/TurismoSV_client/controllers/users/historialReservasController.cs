...
{
    internal class historialReservasController
    {
        //
        ...
        public async Task<bool> fn_GetReservasList(String username)
        {
            bool resp = false;
            ...
            string apiAddress = RoutesApi.GetRoute("historialReservas");
