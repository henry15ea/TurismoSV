...
namespace TurismoSV_client.controllers.infoPaqueteController
{
    internal class infoPaqueteController
    {
        //
        ...
        public async Task<bool> fn_GetPaqueteInfo(String idPaquete)
        {
            bool resp = false;
            ...
            string apiAddress = RoutesApi.GetRoute("paquetesInfo");

            using (httpClient)
            {
                var data = new { idpaqueted = idPaquete.ToString().Trim() };
